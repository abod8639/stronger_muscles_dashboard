...
Map<String, dynamic> _mapProductJson(Map<String, dynamic> json) {
  ...
  return {
    ...
    'discount_price':
        (json['discount_price'] != null || json['discountPrice'] != null)
        ? double.tryParse(
    ...
    'stock_quantity':
        int.tryParse(
          (json['stock_quantity'] ?? json['stockQuantity'] ?? 0).toString(),
        ) ??
        0,
    'is_active':
        json['is_active'] == true ||
        ...
        json['isActive'] == true,
    'is_background_white':
        json['is_background_white'] == true ||
        json['is_background_white'] == 1 ||
        json['isBackgroundWhite'] == true,
    'ingredients': toList(json['ingredients']),
    'usage_instructions': toStringSafe(
      json['usage_instructions'] ?? json['usageInstructions'],
    ),
    'warnings': toStringSafe(json['warnings']),
    'manufacturer': toStringSafe(json['manufacturer']),
    'country_of_origin': toStringSafe(
      json['country_of_origin'] ?? json['countryOfOrigin'],
    ),
    'meta_title': toStringSafe(json['meta_title'] ?? json['metaTitle']),
    'meta_description': toStringSafe(
